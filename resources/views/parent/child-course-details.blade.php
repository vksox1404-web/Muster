...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4 pt-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="text-muted fw-bold mb-0">{{ $child->name }}'s academic details in {{ $course->name }}</h4>
        </div>
    </div>
</div>
                    ...
                    <div class="mt-2">
                        @if ($grade->total > $averageGrade)
                            <div class="alert alert-success" role="alert">
                                ...
                                <strong>Excellent performance!</strong> Your child is {{ number_format($grade->total - $averageGrade, 1) }} points above average.
                                <small>Keep encouraging them to maintain this excellent performance.</small>
                            </div>
                        @elseif($grade->total < $averageGrade)
                            <div class="alert alert-danger" role="alert">
                                <i class="fa-solid fa-circle-down me-2"></i>
                                <strong>Needs attention.</strong> Your child is {{ number_format($averageGrade - $grade->total, 1) }} points below average.
                                <small>Consider discussing tutoring options with their professor.</small>
                            </div>
                        @else
                            <div class="alert alert-info" role="alert">
                                <i class="fa-solid fa-thumbs-up me-2"></i>
                                <strong>Steady progress!</strong> Your child is at the class average.
                                <small>Encourage them to keep improving.</small>
                            </div>
                        @endif
                    </div>
                </div>
                            ...
                            <div class="rounded">
                                ...
                                <div class="mt-3">
                                    @if ($attendanceRate > $departmentAverageAttendance)
                                        <div class="alert alert-success" role="alert">
                                            <i class="fa-solid fa-circle-up me-2"></i>
                                            <strong>Excellent attendance!</strong> Your child is {{ number_format($attendanceRate - $departmentAverageAttendance, 1) }}% above the department average.
                                            <small>Encourage them to maintain this excellent attendance record!</small>
                                        </div>
                                    @elseif($attendanceRate < $departmentAverageAttendance)
                                        <div class="alert alert-danger" role="alert">
                                            <i class="fa-solid fa-circle-down me-2"></i>
                                            <strong>Needs attention.</strong> Your child is {{ number_format($departmentAverageAttendance - $attendanceRate, 1) }}% below the department average.
                                            <small>Consider discussing attendance concerns with their professor.</small>
                                        </div>
                                    @else
                                        <div class="alert alert-info" role="alert">
                                            <i class="fa-solid fa-thumbs-up me-2"></i>
                                            <strong>Steady attendance!</strong> Your child's attendance matches the department average.
                                            <small>Encourage them to maintain this consistent attendance.</small>
                                        </div>
                                    @endif
                                </div>
                            </div>
